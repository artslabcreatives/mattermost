        ...
        try {
            ...
            if (resp.ok) {
                ...
                if (!data || !data.allowed) {
                    // User is not allowed to see or access DriveHub
                    return;
                }
            }
        } catch (err) {
...
declare global {
    interface Window {
        registerPlugin(pluginId: string, plugin: DriveHubPlugin): void;
    }
}

window.registerPlugin(manifest.id, new DriveHubPlugin());
