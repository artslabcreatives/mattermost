        ...
        try {
            ...
            if (resp.ok) {
                ...
                if (!data || !data.allowed) {
                    // User is not allowed to see or access Jothika
                    return;
                }
            }
        } catch (err) {
...
declare global {
    interface Window {
        registerPlugin(pluginId: string, plugin: JothikaPlugin): void;
    }
}

window.registerPlugin(manifest.id, new JothikaPlugin());
