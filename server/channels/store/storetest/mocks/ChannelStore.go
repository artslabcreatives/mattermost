...
// ResetLastPictureUpdate provides a mock function with given fields: channelID
func (_m *ChannelStore) ResetLastPictureUpdate(channelID string) error {
	ret := _m.Called(channelID)
...
func (_m *ChannelStore) UpdateLastPictureUpdate(channelID string) error {
	ret := _m.Called(channelID)
