...
export type JobType = 'data_retention' | 'elasticsearch_post_indexing' | 'typesense_post_indexing' | 'bleve_post_indexing' | 'ldap_sync' | 'message_export' | 'access_control_sync';
