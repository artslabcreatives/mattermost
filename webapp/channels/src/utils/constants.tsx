...
export const ModalIdentifiers = {
	...
	VIDEO_NOTE_MODAL: 'video_note_modal',
...
export const JobTypes = {
	...
	TYPESENSE_POST_INDEXING: 'typesense_post_indexing',
...
defineMessages({
	...
	socketError: {
		...
		defaultMessage: 'Please check connection, Aura unreachable. If issue persists, ask administrator to [check WebSocket port](!https://docs.mattermost.com/install/troubleshooting.html#please-check-connection-mattermost-unreachable-if-issue-persists-ask-administrator-to-check-websocket-port).',
	},
...
export const Constants = {
	...
	IMAGE_TYPES: ['jpg', 'gif', 'bmp', 'png', 'jpeg', 'tiff', 'tif', 'webp', 'avif'],
