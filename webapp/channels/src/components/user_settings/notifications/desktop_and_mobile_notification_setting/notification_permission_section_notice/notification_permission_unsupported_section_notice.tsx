        ...
        <div className='extraContentBeforeSettingList'>
            <SectionNotice
                ...
                text={intl.formatMessage({
                    ...
                    defaultMessage: 'You\'re missing important message and call notifications from Aura. To start receiving notifications, please update to a supported browser.',
                })}
                tertiaryButton={{
                    text: intl.formatMessage({
