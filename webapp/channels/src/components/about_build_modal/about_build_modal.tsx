	...
	let learnMore = (
		<div>
			<FormattedMessage
				...
				defaultMessage='Join the Aura community at '
			/>
			<ExternalLink
			...
			learnMore = (
				<div>
					<FormattedMessage
						...
						defaultMessage='Learn more about Aura {planName} at {link}'
						values={{
							planName: skuName,
							link: (
								<ExternalLink
			...
			<Modal.Body>
				...
				<div className='about-modal__footer'>
					...
					<div className='form-group'>
						<div className='about-modal__copyright'>
							<FormattedMessage
								id='about.copyright'
								defaultMessage='Copyright 2015 - {currentYear} Aura, Inc. All rights reserved'
								values={{
				...
				<div className='about-modal__notice form-group pt-3'>
					<p>
						<FormattedMessage
							id='about.notice'
							defaultMessage='Aura is made possible by the open source software used in our <linkServer>server</linkServer>, <linkDesktop>desktop</linkDesktop> and <linkMobile>mobile</linkMobile> apps.'
							values={{
