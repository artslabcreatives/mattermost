                    ...
                    <IntegrationOption
                        ...
                        description={
                            <FormattedMessage
                                ...
                                defaultMessage='OAuth 2.0 allows external applications to make authorized requests to the Aura API'
                            />
                        }
                ...
                <IntegrationOption
                    ...
                    description={
                        <FormattedMessage
                            ...
                            defaultMessage='Use bot accounts to integrate with Aura through plugins or the API'
                        />
                    }
            ...
            <div className='backstage-content row'>
                ...
                <div className='backstage-list__help'>
                    <FormattedMessage
                        ...
                        defaultMessage='Visit the {appDirectory} to find self-hosted, third-party apps and integrations for Aura.'
                        values={{
                            appDirectory: (
                                <ExternalLink
