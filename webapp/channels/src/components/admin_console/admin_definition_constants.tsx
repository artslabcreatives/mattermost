	...
	<tr>
		...
		<td>
			<FormattedMessage
				...
				defaultMessage='Aura will connect over an insecure connection.'
			/>
		</td>
	</tr>
);
	...
	<tr>
		...
		<td>
			<FormattedMessage
				...
				defaultMessage='Encrypts the communication between Aura and your server.'
			/>
		</td>
	</tr>
);
				...
				<tr>
					...
					<td>
						<FormattedMessage
							...
							defaultMessage='The Aura server will serve static files compressed with gzip.'
						/>
					</td>
				</tr>
				<tr>
					...
					<td>
						<FormattedMessage
							...
							defaultMessage='The Aura server will serve static files uncompressed.'
						/>
					</td>
				</tr>
				<tr>
					...
					<td>
						<FormattedMessage
							...
							defaultMessage='The Aura server will not serve static files.'
						/>
					</td>
				</tr>
			</tbody>
