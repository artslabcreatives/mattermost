		...
		return (
			<SettingsGroup>
				...
				<div>
					<label>
						<FormattedMessage
							id='admin.typesense.bulkIndexingTitle'
							defaultMessage='Bulk Indexing:'
						/>
					</label>
					<div className='help-text'>
						<FormattedMessage
							id='admin.typesense.bulkIndexingHelp'
							defaultMessage='Bulk index all posts, channels, users, and files in the database.'
						/>
					</div>
					<div className='job-table-setting'>
						<JobsTable
							jobType={JobTypes.TYPESENSE_POST_INDEXING as JobType}
							disabled={!this.state.canPurgeAndIndex || this.props.isDisabled!}
							createJobButtonText={
								<FormattedMessage
									id='admin.typesense.createJob.title'
									defaultMessage='Index Now'
								/>
							}
							createJobHelpText={
								<FormattedMessage
									id='admin.typesense.createJob.help'
									defaultMessage='All posts, channels, users, and files in the database will be indexed from oldest to newest. Typesense is available during indexing but search results may be incomplete until the indexing job is complete.'
								/>
							}
						/>
					</div>
