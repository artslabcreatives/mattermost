    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Integrate Active Directory/LDAP with Aura Professional',
            })}
            copy={defineMessage({
                id: 'admin.ldap_feature_discovery.copy',
                defaultMessage: 'When you connect Aura with your organization\'s Active Directory/LDAP, users can log in without having to create new usernames and passwords.',
            })}
