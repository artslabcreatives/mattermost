    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Create custom terms of service with Aura Enterprise',
            })}
            copy={defineMessage({
                id: 'admin.custom_terms_of_service_feature_discovery.copy',
                defaultMessage: 'Create your own terms of service that new users must accept before accessing your Aura instance on desktop, web, or mobile.',
            })}
