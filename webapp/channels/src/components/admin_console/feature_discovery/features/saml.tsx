	...
	return (
		<FeatureDiscovery
			...
			title={defineMessage({
				...
				defaultMessage: 'Integrate SAML 2.0 with Aura Professional',
			})}
			copy={defineMessage({
				id: 'admin.saml_feature_discovery.copy',
				defaultMessage: 'When you connect Aura with your organization\'s single sign-on provider, users can access Aura without having to re-enter their credentials.',
			})}
