        ...
        content = (
            <>
                <FormattedMessage
                    ...
                    defaultMessage='Experience all that Aura Enterprise Advanced has to offer with a free trial for the next 30 days. No obligation to buy and no credit card required. '
                />
                <FormattedMessage
                    id='admin.license.trial-request.accept-terms'
                    defaultMessage='By clicking <strong>Start trial</strong>, I agree to the <linkEvaluation>Aura Software and Services License Agreement</linkEvaluation>, <linkPrivacy>Privacy Policy</linkPrivacy>, and receiving product emails.'
                    values={{
        ...
        content = (
            <>
                <FormattedMessage
                    ...
                    defaultMessage='Upgrade to the Enterprise Edition to unlock a free 30-day trial of Aura Enterprise Advanced—our most powerful plan. No credit card required, no obligation to buy. '
                />
            </>
        );
        upgradeTermsMessage = (
            ...
            <>
                <p className='upgrade-legal-terms'>
                    <FormattedMessage
                        ...
                        defaultMessage='By selecting <strong>Upgrade Server And Start trial</strong>, I agree to the <linkEvaluation>Aura Software Evaluation Agreement</linkEvaluation>, <linkPrivacy>Privacy Policy</linkPrivacy>, and receiving product emails. '
                        values={{
                            strong: (msg: React.ReactNode) => <strong>{msg}</strong>,
                            linkEvaluation: (msg: React.ReactNode) => (
                                <ExternalLink
                    ...
                    <FormattedMessage
                        ...
                        defaultMessage='Also, I agree to the terms of the Aura {eeModalTerms}. Upgrading will download the binary and update your Team Edition instance.'
                        values={{eeModalTerms}}
                    />
                </p>
                {upgradeError && (
        ...
        <AlertBanner
            ...
            title={
                <FormattedMessage
                    ...
                    defaultMessage='Start a free 30-day trial of Aura Enterprise Advanced'
                />
            }
            message={
