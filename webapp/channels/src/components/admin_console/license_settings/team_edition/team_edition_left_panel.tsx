	...
	return (
		<div className='TeamEditionLeftPanel'>
			...
			<div className='TeamEditionLeftPanel__LicenseNotices'>
				<p>{'When using Aura Artslab Edition, the software is offered under a Aura MIT Compiled License. See MIT-COMPILED-LICENSE.md in your root install directory for details.'}</p>
				<p>
