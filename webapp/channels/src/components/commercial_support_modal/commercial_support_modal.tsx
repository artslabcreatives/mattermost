                ...
                <Modal.Body>
                    <div className='CommercialSupportModal'>
                        <FormattedMessage
                            ...
                            defaultMessage={'If you\'re experiencing issues, <supportLink>submit a support ticket</supportLink>. To help with troubleshooting, it\'s recommended to download the Support Packet below that includes more details about your Aura environment.'}
                            values={{
                                supportLink: (chunks) => (
                                    <ExternalLink
                                        href={supportLink}
