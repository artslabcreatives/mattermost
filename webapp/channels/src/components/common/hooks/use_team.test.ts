...
import { useTeam, useTeamByName } from './use_team';
...
describe('useTeamByName', () => {
	const team1 = TestHelper.getTeamMock({ id: 't1', name: 'team1' });
	const team2 = TestHelper.getTeamMock({ id: 't2', name: 'team2' });
