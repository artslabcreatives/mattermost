...
STATE_FILE_PATH = "/var/www/mattermost-collab-prod/followup_reminded_threads.json"
...
def load_env_file():
    env_path = "/var/www/mattermost-collab-prod/.env"
...
def get_admin_token():
    ...
    try:
        cmd = [
            "sudo", "docker", "exec", "mattermost-server",
